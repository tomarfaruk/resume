...
class TemplateTwelve {
  ...
  Widget buildPdfHeader() {
    ...
    if (fname.isNotEmpty || lanme.isNotEmpty) {
      nameChild = Text('$fname $lanme',
          style: TextStyle(fontSize: 70, font: ttf, color: PdfColors.black));
    }
      ...
      child: Row(
        ...
        children: [
          ...
          Column(
            ...
            crossAxisAlignment: CrossAxisAlignment.center,
            children: [nameChild, professionChild],
          ),
        ],
      ),
    );
  ...
  Widget socialProfile() {
    List<Widget> widgets = [SizedBox(height: 0.4 * PdfPageFormat.cm)];
